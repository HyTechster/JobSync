...
const ROLE_LABEL = { admin: 'Administrator', technician: 'Technician' } as const
  ...
  return (
    <div className="px-4 pt-6 pb-2 max-w-lg mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-[22px] font-bold text-text-base">Profile</h1>
        {!isEditing && (
          <button
            onClick={startEdit}
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <span className="mt-1.5 px-2.5 py-0.5 rounded-full bg-brand-50 text-brand-700 text-[11.5px] font-semibold">
